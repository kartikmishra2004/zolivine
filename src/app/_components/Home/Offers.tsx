...
export default function Offers() {
    ...
    return (
        <section ref={screenRef} className="w-full h-[120vh] flex relative overflow-hidden">
                    ...
                    <div className="h-[300px] flex justify-between w-[49.9vw] p-12">
                        <div className="">
                            <div className="overflow-hidden">
                                <h1 ref={title1Ref} className="text-6xl font-semibold text-zinc-700">EXCITING</h1>
                            </div>
                            <div className="overflow-hidden">
                                <h1 ref={title2Ref} className="text-6xl font-semibold text-zinc-700">OFFERS <span className={`${EditorialNew.className} font-normal`}>awaits</span></h1>
                            </div>
                            <div className="overflow-hidden">
